...
class BluetoothDevice {
  ...
  Future<void> openL2CapChannel({
    ...
    await FlutterBluePlus._invokeMethod(() =>
        FlutterBluePlusPlatform.instance.openL2CapChannel(request));
  }
  ...
  Future<void> closeL2CapChannel({required final int psm}) async {
    ...
    await FlutterBluePlus._invokeMethod(() =>
        FlutterBluePlusPlatform.instance.closeL2CapChannel(request));
  }
  ...
  Future<List<int>> readL2CapChannel({
    ...
    return await FlutterBluePlus._invokeMethod(() =>
        FlutterBluePlusPlatform.instance.readL2CapChannel(request))
  ...
  Future<void> writeL2CapChannel(
    ...
    await FlutterBluePlus._invokeMethod(() =>
        FlutterBluePlusPlatform.instance.writeL2CapChannel(request));
  }

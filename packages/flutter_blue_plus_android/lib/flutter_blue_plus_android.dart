...
final class FlutterBluePlusAndroid extends FlutterBluePlusPlatform {
  ...
  // L2CAP Methods
  final _onL2CapChannelConnectedController = StreamController<BmL2CapChannelConnected>.broadcast();

  @override
  Stream<BmL2CapChannelConnected> get onL2CapChannelConnected {
    return _onL2CapChannelConnectedController.stream;
  }

  @override
  Future<BmListenL2CapChannelResponse> listenL2CapChannel(
    BmListenL2CapChannelRequest request,
  ) async {
    final result = await _invokeMethod<Map<dynamic, dynamic>>(
      'listenL2CapChannel',
      request.toMap(),
    );
    return BmListenL2CapChannelResponse.fromMap(result!);
  }

  @override
  Future<bool> closeL2CapServer(
    BmCloseL2CapServer request,
  ) async {
    return await _invokeMethod<bool>(
      'closeL2CapServer',
      request.toMap(),
  ...
  @override
  Future<bool> openL2CapChannel(
    BmOpenL2CapChannelRequest request,
  ) async {
    return await _invokeMethod<bool>(
      'connectToL2CapChannel',
      request.toMap(),
    ) == true;
  }

  @override
  Future<bool> closeL2CapChannel(
    BmCloseL2CapChannelRequest request,
  ) async {
    return await _invokeMethod<bool>(
      'closeL2CapChannel',
      request.toMap(),
  ...
  @override
  Future<BmReadL2CapChannelResponse> readL2CapChannel(
    BmReadL2CapChannelRequest request,
  ) async {
    final result = await _invokeMethod<Map<dynamic, dynamic>>(
      'readL2CapChannel',
      request.toMap(),
    );
    return BmReadL2CapChannelResponse.fromMap(result!);
  }

  @override
  Future<bool> writeL2CapChannel(
    BmWriteL2CapChannelRequest request,
  ) async {
    return await _invokeMethod<bool>(
      'writeL2CapChannel',
      request.toMap(),
  ...
  Future<void> _methodCallHandler(
    ...
    switch (call.method) {
      ...
      case 'deviceConnectedToL2CapChannel':
        return _onL2CapChannelConnectedController.add(
          BmL2CapChannelConnected.fromMap(
            call.arguments,
          ),
        );
    }

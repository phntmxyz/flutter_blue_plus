...
class BmL2CapChannelConnected {
  ...
  BmL2CapChannelConnected({
    required this.device,
    required this.psm,
  });

  factory BmL2CapChannelConnected.fromMap(Map<dynamic, dynamic> map) {
    return BmL2CapChannelConnected(
      device: BmBluetoothDevice.fromMap(map['bluetoothDevice']),
      psm: map['psm'],
    );
  }
}
...
class BmListenL2CapChannelResponse {
  ...
  BmListenL2CapChannelResponse({required this.psm});

  factory BmListenL2CapChannelResponse.fromMap(Map<dynamic, dynamic> map) {
    return BmListenL2CapChannelResponse(psm: map['psm']);
  }
}
...
class BmReadL2CapChannelResponse {
  ...
  factory BmReadL2CapChannelResponse.fromMap(Map<dynamic, dynamic> map) {
    return BmReadL2CapChannelResponse(
      remoteId: map['remote_id'],
      psm: map['psm'],
      bytesRead: map['bytes_read'],
      value: map['value'] is String ? _hexDecode(map['value']) : List<int>.from(map['value']),
    );
  }
}
